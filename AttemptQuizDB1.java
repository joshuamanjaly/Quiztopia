...
public class AttemptQuizDB1 extends JFrame {
    ...
    // Inside initializeUI method (replace existing version)
    ...
    private void initializeUI() {
        ...
        headerPanel.setBackground(new Color(30, 30, 30)); // DARK THEME

        JLabel headerLabel = new JLabel("QUIZTOPIA", SwingConstants.CENTER);
        headerLabel.setFont(new Font("Arial", Font.BOLD, 32));
        headerLabel.setForeground(Color.WHITE); // DARK THEME
        headerPanel.add(headerLabel, BorderLayout.CENTER);

        // Timer Label
        timerLabel = new JLabel("Time Remaining: 30:00", SwingConstants.RIGHT);
        timerLabel.setFont(new Font("Arial", Font.BOLD, 16));
        timerLabel.setForeground(Color.LIGHT_GRAY); // DARK THEME
        ...
        quizPanel.setBackground(new Color(45, 45, 45)); // DARK THEME
        ...
        scrollPane.getViewport().setBackground(new Color(45, 45, 45)); // DARK THEME
        add(scrollPane, BorderLayout.CENTER);

        // Question
        questionLabel = new JLabel();
        questionLabel.setFont(new Font("Arial", Font.BOLD, 16));
        questionLabel.setForeground(Color.WHITE); // DARK THEME
        ...
        for (int i = 0; i < 4; i++) {
            ...
            optionButtons[i].setForeground(Color.LIGHT_GRAY); // DARK THEME
            optionButtons[i].setBackground(new Color(45, 45, 45)); // DARK THEME
        ...
        navigationPanel.setBackground(new Color(30, 30, 30)); // DARK THEME
        nextButton = new JButton("Next");
        nextButton.setFont(new Font("Arial", Font.BOLD, 14));
        nextButton.setBackground(new Color(70, 130, 180)); // Soft blue
        nextButton.setForeground(Color.WHITE); // DARK THEME
